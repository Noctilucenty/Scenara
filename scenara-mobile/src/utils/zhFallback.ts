const EXACT_TITLE_MAP: Record<string, string> = {
  ...
  // --- News titles: Ethereum / ETF ---
  "crypto today: bitcoin, ethereum, xrp technicals deteriorate amid war-driven risk-off sentiment": "加密货币今日：比特币、以太坊、瑞波币技术面在战争驱动的避险情绪中恶化。",
  "ethereum spot etfs saw a net inflow of $47.7524 million yesterday, with only blackrock etf etha achieving net inflows": "以太坊现货ETF昨日净流入4775.24万美元，仅贝莱德ETF ETHA实现净流入。",
  "ethereum price today: eth rises as market recovers": "以太坊今日行情：市场回暖，ETH上涨。",
  "ethereum and bitcoin etf inflows surge amid institutional demand": "机构需求激增推动以太坊和比特币ETF资金大幅流入。",
  ...
  "which country will win the 2026 world cup?": "哪个国家会赢得2026年世界杯？",
  "will openai release gpt-5 in 2026?": "OpenAI会否在2026年发布GPT-5？",

  // --- Ethereum / Crypto ETF ---
  "will ethereum etf inflows exceed $1b in a single week in 2026?": "以太坊ETF单周净流入会否在2026年超过10亿美元？",
  "will bitcoin etf inflows exceed $1b in a single week in 2026?": "比特币ETF单周净流入会否在2026年超过10亿美元？",
  "will a sovereign wealth fund disclose bitcoin etf holdings in 2026?": "2026年是否会有主权财富基金披露比特币ETF持仓？",
  "will ethereum reach $5,000 in 2026?": "以太坊会否在2026年突破5000美元？",
  "will ethereum reach $10,000 in 2026?": "以太坊会否在2026年突破1万美元？",
  "will ethereum flip bitcoin in market cap in 2026?": "以太坊市值会否在2026年超越比特币？",
};

const REPLACEMENTS: Array<[RegExp, string]> = [
  // Long phrases first — crypto / ETF news article vocabulary
  [/\bspot etf\b/gi, "现货ETF"],
  [/\betf inflows?\b/gi, "ETF资金流入"],
  [/\bnet inflow\b/gi, "净流入"],
  [/\bnet outflow\b/gi, "净流出"],
  [/\bblackrock\b/gi, "贝莱德"],
  [/\bethereumspot\b/gi, "以太坊现货"],
  [/\bethereumeth\b/gi, "以太坊"],
  [/\bethereum\b/gi, "以太坊"],
  [/\bbitcoin\b/gi, "比特币"],
  [/\bbtc\b/gi, "比特币"],
  [/\beth\b(?=\s|$)/gi, "以太坊"],
  [/\bxrp\b/gi, "瑞波币"],
  [/\bcrypto today\b/gi, "加密货币今日"],
  [/\bcryptocurrenc\w*\b/gi, "加密货币"],
  [/\bcrypto\b/gi, "加密货币"],
  [/\bblockchain\b/gi, "区块链"],
  [/\btechnicals?\b/gi, "技术面"],
  [/\brisk-off sentiment\b/gi, "避险情绪"],
  [/\brisk-off\b/gi, "避险"],
  [/\bsentiment\b/gi, "情绪"],
  [/\bwar-driven\b/gi, "战争驱动"],
  [/\bdeteriorate\b/gi, "恶化"],
  [/\bwealth transfer\b/gi, "财富转移"],
  [/\bon-chain\b/gi, "链上"],
  [/\bon chain\b/gi, "链上"],
  [/\bchain signals?\b/gi, "链上信号"],
  [/\btariff reprieve\b/gi, "关税暂缓"],
  [/\bboosts?\b/gi, "提振"],
  [/\brisk assets?\b/gi, "风险资产"],
  [/\baltcoins?\b/gi, "山寨币"],
  [/\brally\b/gi, "反弹"],
  [/\btariff pause\b/gi, "关税暂停"],
  [/\bpauses? tariffs?\b/gi, "暂停关税"],
  [/\breclaims?\b/gi, "重回"],
  [/\bjumps?\b/gi, "大涨"],
  [/\bsoars?\b/gi, "飙升"],
  [/\bsurges?\b/gi, "暴涨"],
  ...
  [/\byesterday\b/gi, "昨日"],
  [/\btoday:\b/gi, "今日："],
  [/\bprice today\b/gi, "今日行情"],
  [/\bachiev\w*\b/gi, "实现"],
  [/\bonly\b/gi, "仅"],
  [/\bmillion\b/gi, "百万"],
  [/\bbillion\b/gi, "十亿"],
  [/\bquadrillion\b/gi, "千万亿"],
  [/\btrillion\b/gi, "万亿"],
  [/\bprediction\b/gi, "预测"],
  [/\bquadratic\b/gi, "二次"],
  [/\btariff\b/gi, "关税"],
  ...
  [/\bmarket cap\b/gi, "市值"],
  [/\bstablecoin\b/gi, "稳定币"],
  [/\bdefi\b/gi, "去中心化金融"],
  [/\bnft\b/gi, "NFT"],
  [/\bwho will win\b/gi, "谁将赢得"],
  [/\bwhich country\b/gi, "哪个国家"],
