...
export function hasSeenOnboarding(): boolean {
  try {
    if (Platform.OS === "web") {
      return localStorage.getItem("scenara_onboarded") === "1";
    }
    return false;
  } catch {
    return false;
...
export function markOnboardingDone(): void {
  try {
    if (Platform.OS === "web") {
      localStorage.setItem("scenara_onboarded", "1");
    }
  } catch {}
}
            ...
            >
              ...
              <View
                style={{
                  ...
                  borderRadius: 11,
                  borderWidth: 2,
                  borderColor: isSelected ? PURPLE : TEXT_MID,
                  alignItems: "center",
                  justifyContent: "center",
...
export default function OnboardingScreen() {
  ...
  return (
    ...
    >
      ...
      >
        {stage === "lang" && <LanguageSelectScreen onSelect={handleLangSelect} />}
        ...
        {stage === "slides" && (
          <>
            ...
            >
                ...
                {slide.icon === "chart" && (
                  ...
                  >
                    <Svg width="40" height="40" viewBox="0 0 24 24">
                      <Polyline
                        points="3,17 7,9 11,13 15,7 19,10"
                        stroke={BLUE}
                        strokeWidth="2"
                        fill="none"
                        strokeLinecap="round"
              ...
              {"extra" in slide && slide.extra === "balance" && (
                <View
                  style={{
                ...
                {slides.map((_, i) => (
                  <View
                    ...
                    style={{
                      ...
                      width: i === cur ? 20 : 6,
                      backgroundColor:
                        i === cur ? PURPLE : "rgba(255,255,255,0.15)",
                    }}
                  />
                ))}
              </View>
