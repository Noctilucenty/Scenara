...
export default function LanguageSelectScreen() {
  ...
  const [selected, setSelected] = useState<"pt" | "en" | null>(null);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: BG, alignItems: "center", justifyContent: "center", padding: 28 }}>
      ...
      <Text style={{ color: TEXT, fontSize: 28, fontFamily: "DMSans_700Bold", letterSpacing: -0.5, marginBottom: 8 }}>
        scenara
      </Text>
          ...
          return (
            <TouchableOpacity
              ...
              style={{
                ...
                backgroundColor: isSelected ? "rgba(124,92,252,0.1)" : CARD,
      ...
      <View style={{ width: "100%", maxWidth: 380 }}>
        <TouchableOpacity
          onPress={confirm}
          disabled={!selected}
          style={{ borderRadius: 16, overflow: "hidden", opacity: selected ? 1 : 0.4 }}
        >
          <LinearGradient
