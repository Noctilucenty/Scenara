...
STATIC_EVENTS = [
    ...
    {
        "slug_key": "lollapalooza-br-2026",
        "title": "Will Lollapalooza Brasil 2026 sell out in under 24 hours?",
        "title_pt": "O Lollapalooza Brasil 2026 vai esgotar os ingressos em menos de 24 horas?",
        "description": "Lollapalooza Brasil has become one of the biggest music festivals in Latin America. Will tickets sell out instantly?",
        "description_pt": "O Lollapalooza Brasil se tornou um dos maiores festivais de música da América Latina. Os ingressos vão esgotar instantaneamente?",
        "category": "music",
        "scenarios": [("Yes", 67), ("No", 33)],
        "scenarios_pt": [("Sim", 67), ("Não", 33)],
    },
